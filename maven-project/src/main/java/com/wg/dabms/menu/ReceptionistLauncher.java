...
public class ReceptionistLauncher {
	...
	public static void launchMenu(User user) {
		...
		while (condition) {
			...
			switch (choice) {
			case 1:
				ReceptionistNotificationLaunchMenu(user);
				break;
			case 2:
				ReceptionistAppointmentLaunchMenu(user);
				break;
			case 3:
				prescriptionController.readPrescription(user);
				break;
			case 4:
				ReceptionistReviewLaunchMenu(user);
				break;
			case 5:
				ReceptionistProfilelaunchMenu(user);
				break;
			case 6:
				condition = false;
				break;
	...
	public static void ReceptionistNotificationLaunchMenu(User user) {

	}

	public static void ReceptionistAppointmentLaunchMenu(User user) {

	}

	public static void ReceptionistReviewLaunchMenu(User user) {

	}

	public static void ReceptionistProfilelaunchMenu(User user) {
